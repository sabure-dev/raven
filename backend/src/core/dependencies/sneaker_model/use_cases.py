...
from use_cases.sneakers_model.get_sneaker_model import GetSneakerModelUseCase, GetSneakersModelsUseCase
from use_cases.sneakers_model.update_sneaker_model import UpdateSneakerModelUseCase


def get_create_sneaker_model_use_case(
        sneaker_model_service_factory: Callable[[], SneakerModelService] = Depends(get_sneaker_model_service_factory),
